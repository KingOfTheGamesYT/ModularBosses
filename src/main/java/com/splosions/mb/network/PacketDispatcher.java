package com.splosions.mb.network;

import java.util.Collection;

import com.splosions.mb.Reference;
import com.splosions.mb.network.client.OpenControlBlockEditorPacket;
import com.splosions.mb.network.server.SetControlBlockMessagePacket;
		...
		if (entity.world instanceof WorldServer) {
			for (Object o : ((WorldServer) entity.world).playerEntities) {
				if (o instanceof EntityPlayerMP) {
					...
					if (player.getDistanceSq(entity) <= rangeSq) {
						((EntityPlayerMP) o).connection.sendPacket(packet);
					}
				}
			}
